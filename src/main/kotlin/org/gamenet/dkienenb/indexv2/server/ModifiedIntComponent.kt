...
public abstract class ModifiedIntComponent(value: Int) : MutableDataStoringComponent<Int>() {
...
public class ConstantBonusModifier(private val constant: Int) : Modifier() {
    override fun stillValid(): Boolean = true
    override fun active() = true
    override fun modify(current: Int) = (current + constant)
}

public class OverrideValueModifier(val supplier: () -> Int) : Modifier() {
